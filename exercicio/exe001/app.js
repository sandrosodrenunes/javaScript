...
for(let i = 0; i < randomValues.length; i++){
  ...
  let isString = typeofItem === 'string'
  let isBoolena = typeofItem === 'boolean'
...
const fourString = firstFourString.join(', ').replace(`${lastItem}`, `e ${lastItem}`)
...
switch (drinkType){
  case 'agua':
    drinkMenssage = 'Substância química cujas moléculas são formadas por dois átomos de hidrogênio e um de oxigênio.';
    break;
  case 'refrigerante':
    drinkMenssage = 'Bebida não alcoólica e não fermentada, fabricada industrialmente, à base de água mineral e açúcar.'
    break;
  case 'suco':
    drinkMenssage = 'Bebida produzida do líquido extraído de frutos.'
    break;    
  default:
    drinkMenssage = 'Bebida desconhecida.'    
}

console.log(drinkMenssage)
